...
export default class BG {
  ...
  constructor(can: HTMLDivElement) {
    ...
    const g2 = new BoxGeometry(1.2, 0.8, 1);
    ...
    const g3 = new BoxGeometry(1.2, 0.4, 0.2);
    const hair2 = new Mesh(g3, m2);
    hair2.position.y = 0.4;
    hair2.position.z = 0.5;
    hairG.add(hair2);

    const g4 = new BoxGeometry(0.1, 0.8, 0.2);
    ...
    const g5 = new BoxGeometry(0.1, 0.1, 0.1);
    ...
    const g6 = new BoxGeometry(0.3, 0.1, 0.1);
